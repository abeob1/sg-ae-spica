<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DetailedBillReport.aspx.cs"
    Inherits="AE_SPICA_V001.DetailedBillReport" EnableEventValidation="false" MasterPageFile="~/Site.Master" %>
...
<asp:Content ID="DetailedBillReport" ContentPlaceHolderID="CPHSiteMaster" runat="server">
            ...
            <div class="col-lg-12">
                <div class="col-lg-6">
                    <table width="200" border="0" class="table borderless" cellpadding="2px;" cellspacing="2px;">
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="Label2" runat="server" Text="Claim Handler From"></asp:Label><span class="mandatory">*</span>
                            </td>
                            <td>
                                :
                            </td>
                            <td>
                                <asp:DropDownList ID="ddlFromClaimHandler" runat="server" CssClass="form-control input-little">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <asp:Label ID="Label3" runat="server" Text=" Handler To"></asp:Label><span class="mandatory">*</span>
                            </td>
                            <td>
                                :
                            </td>
                            <td>
                                <asp:DropDownList ID="ddlToClaimHandler" runat="server" CssClass="form-control input-little">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="Label5" runat="server" Text="To Company"></asp:Label><span class="mandatory">*</span>
                            </td>
                            <td>
                                :
                            </td>
