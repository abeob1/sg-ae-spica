...
{
    public partial class DueDTInvoiceReport : System.Web.UI.Page
    {
        #region Objects
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                Response.Cookies[Constants.ScreenName].Value = "Due DT Invoice Report";
                if (!IsPostBack)
                {
                    ClearFields();
        ...
        protected void btnShow_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Response.Cookies[Constants.DDIRFromDate].Value = txtFromDate.Text;
                Response.Cookies[Constants.DDIRToDate].Value = txtToDate.Text;
                Response.Cookies[Constants.DDIRFromCompany].Value = ddlFromCompany.SelectedItem.ToString();
                Response.Cookies[Constants.DDIRToCompany].Value = ddlToCompany.SelectedItem.ToString();
                Response.Redirect("ViewDueDTInvoiceReport.aspx", false);
