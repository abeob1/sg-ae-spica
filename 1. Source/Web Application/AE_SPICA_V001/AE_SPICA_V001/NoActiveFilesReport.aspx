<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NoActiveFilesReport.aspx.cs"
    Inherits="AE_SPICA_V001.NoActiveFilesReport" EnableEventValidation="false" MasterPageFile="~/Site.Master" %>
...
<asp:Content ID="NoActiveFilesReport" ContentPlaceHolderID="CPHSiteMaster" runat="server">
            ...
            <div class="col-lg-12">
                <div class="col-lg-6">
                    <table width="200" border="0" class="table borderless" cellpadding="2px;" cellspacing="2px;">
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="lblClub" runat="server" Text="Filter By"></asp:Label><span class="mandatory">*</span>
                            </td>
                            <td>
                                :
                            </td>
                            <td>
                                <asp:DropDownList ID="ddlFilterBy" runat="server" CssClass="form-control input-little">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlBranch" runat="server" CssClass="form-control input-little">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <asp:Label ID="Label3" runat="server" Text="Claim Handler"></asp:Label>
                            </td>
                            <td>
                                :
                            </td>
                            <td>
                                <asp:DropDownList ID="ddlClaimHandler" runat="server" CssClass="form-control input-little">
                                </asp:DropDownList>
                            </td>
                        </tr>
                    </table>
