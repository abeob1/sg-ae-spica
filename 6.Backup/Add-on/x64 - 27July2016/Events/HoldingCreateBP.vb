                ...
                While Not ors.EoF
                    ...
                    If brachCompany.Connected Then
                        ...
                        If branchBP.GetByKey(CardCode) Then
                            ...
                            If p_iDebugMode = DEBUG_ON Then Call WriteToLogFile_Debug("1" & CardCode, sFuncName)
                            ...
                            If p_iDebugMode = DEBUG_ON Then Call WriteToLogFile_Debug("2 " & CardCode, sFuncName)
                            ...
                            If p_iDebugMode = DEBUG_ON Then Call WriteToLogFile_Debug("3 " & CardCode, sFuncName)
                            ...
                            End If
                            If p_iDebugMode = DEBUG_ON Then Call WriteToLogFile_Debug("4" & CardCode, sFuncName)
                            ...
                            End If
                            If p_iDebugMode = DEBUG_ON Then Call WriteToLogFile_Debug("5 " & CardCode, sFuncName)
                            If branchBP.Addresses.Count > 0 Then
                                ...
                                Next
                            End If
                            If p_iDebugMode = DEBUG_ON Then Call WriteToLogFile_Debug("6 " & CardCode, sFuncName)
                            ...
                            Next
                            If p_iDebugMode = DEBUG_ON Then Call WriteToLogFile_Debug("7 " & CardCode, sFuncName)
                            ...
                            If branchBP.ContactEmployees.Count > 0 Then
                                ...
                                Next
                            End If
                            If p_iDebugMode = DEBUG_ON Then Call WriteToLogFile_Debug("8 " & CardCode, sFuncName)
                            branchBP.ContactPerson = oBP.ContactPerson
